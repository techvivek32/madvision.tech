...
export const PROFILES: SiteProfile[] = [
  ...
  {
    slug: "la-familia-barbershop-tucson",
    leadId: "L-025",
    country: "US",
    name: "La Familia Barbershop",
    accent: "#b91c1c",
    accent2: "#991b1b",
    locality: "Downtown Tucson, AZ",
    hero: {
      overline: "Barbershop · Downtown Tucson",
      headline: "Fresh fades in the heart of",
      headlineAccent: "downtown Tucson.",
      sub: "Fades, beard trims and classic cuts from a team Tucson trusts — 5.0 stars across 220+ reviews. Walk in or book, now with a real home online.",
      bullets: ["Skin fades & design cuts", "Beard trims & line-ups", "Walk-ins & online booking"],
    },
    contact: {
      phone: "520-203-8268",
      tel: "tel:+15202038268",
      email: "Lafamiliabarbershop520@gmail.com",
      address: ["59 E Pennington St (top floor, Suite 2)", "Tucson, AZ 85701"],
      mapQuery: "59 E Pennington St, Tucson, AZ 85701",
      socials: [{ label: "Facebook", href: "https://www.facebook.com/la.familia.barbershop.tucson/" }],
    },
    book: { label: "Book on Booksy", href: "https://booksy.com/en-us/1161247_la-familia-barbershop_barber-shop_14795_tucson" },
    services: {
      title: "The board",
      subtitle: "Cuts & shaves",
      note: "Ask in the chair for today's prices — sharp work, fair rates.",
      items: [
        { name: "Haircut / Fade", note: "Standard cuts & skin fades" },
        { name: "Design Cut", note: "Custom line work" },
        { name: "Beard Trim", note: "Shaped & lined up" },
      ],
    },
    reviews: {
      headline: "5.0 stars — 220+ happy clients",
      body: "See the reviews and book on Booksy.",
      links: [
        { label: "Booksy →", href: "https://booksy.com/en-us/1161247_la-familia-barbershop_barber-shop_14795_tucson" },
        { label: "Facebook →", href: "https://www.facebook.com/la.familia.barbershop.tucson/" },
      ],
    },
    hours: [
      { day: "Tuesday – Thursday", time: "10:00am – 6:00pm" },
  ...
  {
    slug: "princess-nails-clayton-park-halifax",
    leadId: "L-026",
    country: "CA",
    name: "Princess Nails Clayton Park",
    accent: "#d81b60",
    accent2: "#be185d",
    locality: "Clayton Park, Halifax",
    hero: {
      overline: "Nail salon · Clayton Park",
      headline: "Beautiful nails in",
      headlineAccent: "Clayton Park.",
      sub: "Gel, acrylic, shellac and spa pedicures at Clayton Park Shopping Centre — walk-ins welcome, seven days a week. Now with a real site so Halifax finds you on Google.",
      bullets: ["Gel, acrylic & shellac", "Manicures & spa pedicures", "Facials & waxing"],
    },
    contact: {
      phone: "902-443-9992",
      tel: "tel:+19024439992",
      email: "princessnailsclaytonpark@gmail.com",
      address: ["278 Lacewood Drive", "Halifax, NS B3M 3N8"],
      mapQuery: "278 Lacewood Drive, Halifax, NS B3M 3N8",
      socials: [{ label: "Facebook", href: "https://www.facebook.com/princessnailsclaytonpark" }],
    },
    book: { label: "Book online", href: "https://www.dashbooking.com/salon/princess-nails-halifax" },
    services: {
      title: "Services",
      subtitle: "Nails & spa",
      note: "Ask about today's prices and combos — walk-ins welcome.",
      items: [
        { name: "Manicure & Pedicure", price: "$40", note: "Combo special", real: true, featured: true },
        { name: "Gel / Shellac", note: "Long-lasting colour" },
        { name: "Acrylic Nails", note: "Full set & fills" },
        { name: "Facials & Waxing", note: "Also available" },
      ],
    },
    hours: [
    ...
    reviews: {
      headline: "Loved in Clayton Park",
      body: "See reviews on Yelp & Facebook.",
      links: [
        { label: "Yelp →", href: "https://www.yelp.ca/biz/princess-nails-halifax" },
        { label: "Facebook →", href: "https://www.facebook.com/princessnailsclaytonpark" },
      ],
    },
  },

  {
    slug: "nails-for-you-plymouth",
    leadId: "L-027",
    country: "UK",
    name: "Nails For You",
    accent: "#9b59b6",
    accent2: "#7c3aed",
    locality: "Plymouth City Centre",
    hero: {
      overline: "Nail salon · Plymouth City Centre",
      headline: "Nails that last, right in the",
      headlineAccent: "city centre.",
      sub: "Manicures, pedicures and custom nail art on Market Avenue — friendly team, student discount, book by phone or Fresha. Now with a proper site to match.",
      bullets: ["Manicures & pedicures", "Custom nail art", "10% student discount"],
    },
    contact: {
      phone: "01752 250260",
      tel: "tel:+441752250260",
      email: "NailsForYouPlymouth@gmail.com",
      address: ["25 Market Avenue", "Plymouth PL1 1PG"],
      mapQuery: "25 Market Avenue, Plymouth PL1 1PG",
      socials: [
        { label: "Facebook", href: "https://www.facebook.com/NailsForYouPlymouth/" },
        { label: "Instagram", href: "https://www.instagram.com/nails_for_you_plymouth/" },
      ],
    },
    book: { label: "Book on Fresha", href: "https://www.fresha.com/lvp/nails-for-you-market-avenue-QvoWjP" },
    services: {
      title: "Services",
      subtitle: "Nails & art",
      note: "10% student discount. Ask about today's prices — book by phone or Fresha.",
      items: [
        { name: "Manicure", note: "Classic & gel" },
        { name: "Pedicure", note: "Relaxing & tidy" },
        { name: "Nail Art", note: "Custom designs" },
      ],
    },
    hours: [
      { day: "Monday – Saturday", time: "9:15am – 6:00pm" },
      { day: "Sunday", time: "Closed", closed: true },
    ],
    reviews: {
      headline: "Loved for long-lasting nails",
      body: "See the work and book on Fresha & Facebook.",
      links: [
        { label: "Fresha →", href: "https://www.fresha.com/lvp/nails-for-you-market-avenue-QvoWjP" },
        { label: "Facebook →", href: "https://www.facebook.com/NailsForYouPlymouth/" },
      ],
    },
  },
  ...
  {
    slug: "pawfect-couture-adelaide",
    leadId: "L-028",
    country: "AU",
    name: "Pawfect Couture Dog Grooming",
    accent: "#2a9d8f",
    accent2: "#0f766e",
    locality: "Hallett Cove, Adelaide",
    hero: {
      overline: "Dog & cat grooming · Hallett Cove",
      headline: "Cage-free pampering for",
      headlineAccent: "your best friend.",
      sub: "Positive dog and cat grooming, daycare and boarding in a safe, fun, cage-free space in Hallett Cove. Now with a real site so owners can find and book you online.",
      bullets: ["Dog & cat grooming", "Cage-free daycare", "Pet boarding"],
    },
    contact: {
      phone: "0468 948 379",
      tel: "tel:+61468948379",
      email: "pawfectcouturedgps@gmail.com",
      address: ["53 Grand Central Ave", "Hallett Cove, SA 5158"],
      mapQuery: "53 Grand Central Ave, Hallett Cove, SA 5158",
      socials: [{ label: "Facebook", href: "https://www.facebook.com/pawfectcouture/" }],
    },
    book: { label: "Request a booking" },
    services: {
      title: "Services",
      subtitle: "Grooming, daycare & boarding",
      note: "Priced by your pet's size and needs — message for a quick quote.",
      items: [
        { name: "Dog Grooming", note: "Positive & cage-free" },
        { name: "Cat Grooming", note: "Gentle and careful" },
        { name: "Daycare", note: "Cage-free & fun" },
        { name: "Pet Boarding", note: "Safe overnight stays" },
      ],
    },
    reviews: {
      headline: "Cage-free grooming Hallett Cove loves",
      body: "See happy pets on Facebook.",
      links: [{ label: "Facebook →", href: "https://www.facebook.com/pawfectcouture/" }],
    },
  },
]
