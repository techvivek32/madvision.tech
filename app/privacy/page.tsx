    ...
    <div className="pt-32 pb-16 bg-background">
      <div className="container mx-auto px-6">
        ...
        <div className="prose prose-lg max-w-4xl">
          ...
          <p className="text-muted-foreground mb-6">Email: info@madvision.tech<br/>Phone: +91 96011 76051<br/>Head Office: R.K. Empire, Rajkot, Gujarat, India<br/>Ahmedabad Branch: E-1106, Titanium City Center Business Park, Ahmedabad, Gujarat 380015</p>
          ...
          <p className="text-muted-foreground">Vision Tech<br/>Email: info@madvision.tech<br/>Phone: +91 96011 76051<br/>Head Office: R.K. Empire, Rajkot, Gujarat, India<br/>Ahmedabad Branch: E-1106, Titanium City Center Business Park, Ahmedabad, Gujarat 380015</p>
        </div>
      </div>
    </div>
  )
