    ...
    <div className="pt-32 pb-16 bg-background">
      <div className="container mx-auto px-6">
        ...
        <div className="prose prose-lg max-w-4xl">
          ...
          <p className="text-muted-foreground mb-6">Name: Grievance Officer<br/>Email: madevisionstudios@gmail.com<br/>Phone: +91 96011 76051<br/>Response time: 72 hours</p>
          
          <h2 className="text-2xl font-semibold mb-4 text-foreground">14. Contact Information</h2>
          <p className="text-muted-foreground">Vision Tech<br/>Email: madevisionstudios@gmail.com<br/>Phone: +91 96011 76051<br/>Head Office: R.K. World Tower, Rajkot, Gujarat, India<br/>Ahmedabad Branch: Titanium City Center Business Park, Ahmedabad, Gujarat 380015<br/>Business Hours: 9 AM - 6 PM IST</p>
        </div>
      </div>
    </div>
  )
